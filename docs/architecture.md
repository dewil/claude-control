...
Тесты: `tests/test-agent-io.sh`, `tests/test-agent-cli.sh`, `tests/test-agent-run.sh` (юнит, локально), `tests/fault/run-fault-tests.sh` (fault-injection сценарии crash-матрицы + событийные S16-S19, Linux/systemd, с mock-агентом).
