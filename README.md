...
- [`docs/runbook-limits-digest.md`](./docs/runbook-limits-digest.md) - дайджест остатков лимитов Claude/Codex в Telegram (пробник, статусы stale/locked, диагностика).
